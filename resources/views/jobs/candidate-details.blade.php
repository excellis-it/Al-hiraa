                ...
                <tr>
                    ...
                    <td>
                        <select name="ecr_type" class="form-select uppercase-text" id="">
                            ...
                            <option value="ECR" {{ $candidate_job_detail->ecr_type == 'ECR' ? 'selected' : '' }}>ECR</option>
                            <option value="ECNR" {{ $candidate_job_detail->ecr_type == 'ECNR' ? 'selected' : '' }}>ECNR</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                    <div class="form-group">
                        <input type="text" class="form-control uppercase-text" id="" name="contact_no" value="{{ $candidate_job_detail->contact_no ?? '' }}" placeholder="">
                    ...
                    <td>
                        <select name="associate_id" class="form-select uppercase-text new_select2" id="associate_id">
                            ...
                            @foreach ($associates as $associate)
                                <option value="{{ $associate->id }}" {{ $candidate_job_detail->associate_id == $associate->id ? 'selected' : '' }}>
                ...
                <tr>
                    ...
                    <td>
                        <select name="religion" class="form-select uppercase-text" id="">
                            ...
                            <option value="MUSLIM" {{ $candidate_job_detail->religion == 'MUSLIM' ? 'selected' : '' }}>Muslim</option>
            ...
            $('#candidate-form').html(`
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($candidate_job_detail->associate_id && $candidate_job_detail->associate)
                                {{ $candidate_job_detail->associate->name ?? 'N/A' }} ({{ $candidate_job_detail->associate->phone_number ?? '' }})
                            @else
                                N/A
                            @endif
                        </td>
