        ...
        <div class="sidebar sidebar-light sidebar-left simplebar" data-simplebar="">
            ...
            <div class="d-flex align-items-center justify-content-between sidebar-p-a my-4 border-y sidebar-account">
                ...
                <div class="dropdown ms-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item active" href="{{route('dashboard')}}">Dashboard</a>
            ...
            <ul class="sidebar-menu">
                <li class="sidebar-menu-item active open">
                    <a class="sidebar-menu-button" data-toggle="collapse" href="index.html">
                        <i class="sidebar-menu-icon sidebar-menu-icon--left"><img src="assets/images/sidebar-icon/dashboard.svg"></i>
                        <span class="sidebar-menu-text">Dashboard</span>
                    </a>
                </li>
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" href="candidates.html">
                        <i class="sidebar-menu-icon sidebar-menu-icon--left"><img src="assets/images/sidebar-icon/user-helmet-safety.svg"></i>
                        <span class="sidebar-menu-text">Candidates</span>
                    </a>
                </li>
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" href="jobs.html">
                        <i class="sidebar-menu-icon sidebar-menu-icon--left"><img src="assets/images/sidebar-icon/briefcase.svg"></i>
                        <span class="sidebar-menu-text">Jobs</span>
                    </a>
                </li>
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" href="companies.html">
                        <i class="sidebar-menu-icon sidebar-menu-icon--left"><img src="assets/images/sidebar-icon/OfficeBuildings.svg"></i>
                        <span class="sidebar-menu-text">Companies</span>
                    </a>
                </li>
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" href="to_do.html">
                        <i class="sidebar-menu-icon sidebar-menu-icon--left"><img src="assets/images/sidebar-icon/calendar.svg"></i>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" data-bs-toggle="collapse" href="#collapseReports" role="button" aria-expanded="false" aria-controls="collapseReports">
                        <i class="sidebar-menu-icon sidebar-menu-icon--left"><img src="assets/images/sidebar-icon/file-medical-alt.svg"></i>
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                        <i class="sidebar-menu-icon sidebar-menu-icon--left"><img src="assets/images/sidebar-icon/setting.svg"></i>
                        <span class="sidebar-menu-text">Settings</span>
                    </a>
                    <ul class="sidebar-submenu collapse" id="collapseExample">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="team-members.html">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="integrations.html">
                                <span class="sidebar-menu-text">Email & WhatsApp Integration</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="support.html">
            ...
            <div class="conversation">
                ...
                <div class="call_email d-flex align-items-center mb-4">
                    <div class="call_img">
                        <span><img src="assets/images/sidebar-icon/phone-receiver-silhouette.svg" alt=""/></span>
                    </div>
                    <div class="left_call">
                        <span>Call</span>
                ...
                <div class="call_email d-flex align-items-center mb-4">
                    <div class="call_img">
                        <span><img src="assets/images/sidebar-icon/paper-plane.svg" alt=""/></span>
                    </div>
                    <div class="left_call">
                        <span>Email</span>
