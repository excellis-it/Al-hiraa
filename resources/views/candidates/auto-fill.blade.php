    ...
    <div class="col-lg-3">
        <div class="form-group date-btn">
            ...
            <input type="text" class="form-control uppercase-text datepicker" id="dob"
                ...
                autocomplete="false" max="{{ date('d-m-Y') }}" placeholder="dd-mm-yyyy">
            ...
            <select name="referred_by_id" class="form-select  uppercase-text" id="">
                ...
                @foreach ($referrers as $refer)
                    <option value="{{ $refer['id'] }}"
                        {{ $refer['id'] == $candidate->referred_by_id ? 'selected' : '' }}>{{ $refer['full_name'] }}
                    </option>
                    </option>
                @endforeach
            </select>
    ...
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <select name="english_speak" class="form-select  uppercase-text" id="">
                <option value="">Select Type</option>
                <option value="BASIC" {{ strtoupper($candidate->english_speak) == 'BASIC' ? 'selected' : '' }}>BASIC
                </option>
                <option value="GOOD" {{ strtoupper($candidate->english_speak) == 'GOOD' ? 'selected' : '' }}>GOOD
                </option>
                <option value="POOR" {{ strtoupper($candidate->english_speak) == 'POOR' ? 'selected' : '' }}>POOR
                </option>
                <option value="NO" {{ strtoupper($candidate->english_speak) == 'NO' ? 'selected' : '' }}>NO
                </option>
            </select>
        </div>
    </div>
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <select name="arabic_speak" class="form-select  uppercase-text" id="">
                <option value="">Select Type</option>
                <option value="BASIC" {{ strtoupper($candidate->arabic_speak) == 'BASIC' ? 'selected' : '' }}>BASIC
                </option>
                <option value="GOOD" {{ strtoupper($candidate->arabic_speak) == 'GOOD' ? 'selected' : '' }}>GOOD
                </option>
                <option value="POOR" {{ strtoupper($candidate->arabic_speak) == 'POOR' ? 'selected' : '' }}>POOR
                </option>
                <option value="NO" {{ strtoupper($candidate->arabic_speak) == 'NO' ? 'selected' : '' }}>NO
                </option>
            </select>
        </div>
    </div>
