                ...
                <div class="col-xl-9">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-xl-4 col-lg-6">
                            <div class="support-box">
                                <div class="support-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="42.474"
                                        height="42.553" viewBox="0 0 42.474 42.553">
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="support-box">
                                <div class="support-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="45.002"
                                        height="45.002" viewBox="0 0 45.002 45.002">
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="support-box">
                                <div class="support-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36.902"
                                        height="44.078" viewBox="0 0 36.902 44.078">
                                        <g id="marker_2_" data-name="marker (2)"
                                            ...
                                            <circle id="Ellipse_262" data-name="Ellipse 262" cx="5.535"
                                                cy="5.535" r="5.535"
                                                transform="translate(14.916 12.916)" />
                                        </g>
                                    </svg>
                                </div>
                                <div class="support-text">
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="support-box">
                                <div class="support-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36.939"
                                        height="46.691" viewBox="0 0 36.939 46.691">
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="support-box">
                                <div class="support-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="39.43"
                                        height="44.691" viewBox="0 0 39.43 44.691">
